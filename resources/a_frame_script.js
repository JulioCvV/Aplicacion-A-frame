...
AFRAME.registerComponent('escena', {
    ...
    init: function () {
        ...
        console.log(this.totalAssetCount);
    ...
    watchPreloadProgress: function(assetItems){
        for (let a = 0; a < assetItems.length; a++) {
            ...
            assetItems[a].addEventListener(eventName,function(e){
                ...
                if(this.data.debug) {
                    console.log('Loaded ' + this.loadedAssetCount + '/' + this.totalAssetCount + ' asset items');
                }
                this.onAssetLoaded();
            }.bind(this));
        }
    ...
    onAssetLoaded: function(){
        if(this.loadedAssetCount === this.totalAssetCount){
            ...
            let percentage = Math.floor(this.loadedAssetCount/this.totalAssetCount*100);
